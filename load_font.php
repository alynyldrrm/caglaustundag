 ...
 * @throws Exception
 */
function install_font_family($dompdf, $fontname, $normal, $bold = null, $italic = null, $bold_italic = null, $light = null, $extra_light = null, $light_italic = null) {
  ...
  $patterns = array(
    ...
    "light" => array("_Light", "l", "L", "lt", "LT"),
    "extra_light" => array("_Extra_Light", "el", "EL", "le", "LE"),
    "light_italic" => array("_Light_Italic", "li", "LI", "il", "IL")
 );
  ...
  $fonts = compact("normal", "bold", "italic", "bold_italic", "light", "extra_light", "light_italic");
  $entry = array();
...
if ( $_SERVER["argv"][1] === "system_fonts" ) {
  ...
  foreach ( $fonts as $family => $files ) {
    ...
    if ( !isset($files["normal"]) ) {
      ...
      install_font_family($dompdf, $family, @$files["normal"], @$files["bold"], @$files["italic"], @$files["bold_italic"], @$files["light"], @$files["extra_light"], @$files["light_italic"]);
      echo "Done !\n";
    }
