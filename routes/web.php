...
/* |--------------------------------------------------------------------------
| 1. GİRİŞ VE ÇIKIŞ ROTALARI (TÜM MİDDLEWARE'LERDEN BAĞIMSIZ)
|--------------------------------------------------------------------------
| Catch-all (/{permalink}) rotasına takılmaması için en üstte ve dışarıda.
*/
...
/* |--------------------------------------------------------------------------
| 2. SİTE İÇİ VE ADMİN (Yetki Gerektiren) ROTALAR
|--------------------------------------------------------------------------
*/
Route::middleware(['setLanguage', 'defaultDatas'])->group(function () {
    ...
    /* Sadece Giriş Yapmış Adminlerin Görebileceği Rotalar */
