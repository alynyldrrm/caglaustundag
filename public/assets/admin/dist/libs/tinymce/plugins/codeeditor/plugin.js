...
<div id="tox-codeeditor-modal" tabindex="-1">
    <div id="tox-codeeditor-header" role="presentation">
        <div id="tox-codeeditor-modal-title">Kod Düzenleyici</div>
    ...
    <div id="tox-codeeditor-footer">
        ...
        <div role="presentation" id="tox-codeeditor-footer-buttons">
            ...
            <button title="Temizle" type="button" tabindex="-1" onclick="displayToxEditorModal(false)" class="tox-codeeditor-secondary-button">Temizle</button>
            <button title="Kaydet" type="button" tabindex="-1" onclick="saveContent()" class="tox-codeeditor-primary-button">Kaydet</button>
        </div>
    </div>
</div>
    `;
