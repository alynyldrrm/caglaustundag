...
@endsection
@section('content')
    <form method="POST" action="{{ route('admin.form.store', $type->id) }}" autocomplete="off" class="card">
        @csrf
            ...
            <div class="row gy-2">
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" id="form_name" name="form_name">
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" id="success_message"
                ...
                <div class="col-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="" id="error_message" name="error_message">
                    </div>
                </div>
                <div class="col-12">
                    <div class="card">
