...
@section('content')
    <form method="POST" action="{{ route('admin.value.store', $type->id) }}" autocomplete="off" class="card"
        ...
        <div class="card-body">
            <div class="row gy-2">
                ...
                @include('admin.partials.cms.createInputs', ['fields' => $type->fields, 'values' => false])
            </div>
        </div>
