...
<?php if(count($sliders) > 0): ?>
    <div id="heroSlider" class="hero-slider">
        <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="slide <?php echo e($index == 0 ? 'active' : ''); ?>" data-slide="<?php echo e($index); ?>">
                <!-- ARKA PLAN RESMİ - ORİJİNAL RENK, EFEKTSİZ -->
                <div class="slide-image" style="background-image: url('<?php echo e($resim); ?>');"></div>
        ...
        <div class="slider-nav">
            ...
            <div class="slider-dots">
                <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class="dot <?php echo e($index == 0 ? 'active' : ''); ?>" onclick="heroSlider.goTo(<?php echo e($index); ?>)"></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
const heroSlider = {
    ...
    total: <?php echo e(count($sliders)); ?>,
    autoplay: null,
...
<?php endif; ?>
<?php /**PATH C:\Users\Lenovo\danismanlik\danismanlik\resources\views/client/partials/slider.blade.php ENDPATH**/ ?>