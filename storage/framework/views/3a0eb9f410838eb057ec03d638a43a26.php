...
<section class="contact-hero">
    <div class="container">
        <div class="hero-content">
            <h1 class="hero-title"><?php echo e(__('İletişim')); ?></h1>
            <p class="hero-desc"><?php echo e(__('Sorularınız için bize ulaşın')); ?></p>
        </div>
    </div>
</section>
            ...
            <?php if($contactSettings && count($contactSettings) > 0): ?>
                <?php $__currentLoopData = $contactSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-content">
                            <h4><?php echo e(__('Telefon')); ?></h4>
                            <a href="tel:<?php echo e(str_replace(' ', '', $item['phone'])); ?>"><?php echo $item['phone']; ?></a>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-content">
                            <h4><?php echo e(__('E-Posta')); ?></h4>
                            <a href="mailto:<?php echo e($item['email']); ?>"><?php echo $item['email']; ?></a>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="captcha-wrapper">
                            <div class="captcha-display">
                                ...
                                <button type="button" class="captcha-refresh" onclick="location.reload()" title="<?php echo e(__('Yenile')); ?>">
