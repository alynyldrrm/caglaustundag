...
<?php $__env->startSection('title', $menu->name ?? __('Sıkça Sorulan Sorular')); ?>
...
<section class="faq-section">
    <div class="container">
        <?php if($list && count($list) > 0): ?>
            <div class="faq-list">
                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="faq-item">
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p><?php echo e(__('Henüz soru eklenmemiş.')); ?></p>
            </div>
        <?php endif; ?>
    </div>
</section>
...
<?php echo $__env->make('client.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\danismanlik\danismanlik\resources\views/client/ssslar.blade.php ENDPATH**/ ?>