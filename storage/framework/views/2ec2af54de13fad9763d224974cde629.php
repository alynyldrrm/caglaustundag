<?php $__env->startSection('title'); ?>
    <?php echo e($type->single_name); ?> ekle
...
<?php $__env->startSection('content'); ?>
    <form method="POST" action="<?php echo e(route('admin.value.store', $type->id)); ?>" autocomplete="off" class="card"
            ...
            <div class="row gy-2">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" required class="form-control" value="" id="name" name="value_name">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                ...
                <?php echo $__env->make('admin.partials.cms.createInputs', ['fields' => $type->fields, 'values' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const fillFileContainer = (selector, data) => {
                ...
                fileHiddenInputsContainer.innerHTML = inputs;
            }
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\danismanlik\danismanlik\resources\views/admin/values/create.blade.php ENDPATH**/ ?>