...
<body data-plugin-page-transition>
    ...
    <!-- WhatsApp Float Button -->
    <a href="https://api.whatsapp.com/send?phone=<?php echo e(getContact() ? str_replace([' ', '-', '(', ')'], '', getContact()->first()->phone ?? '') : ''); ?>"
       target="_blank"
...
<?php /**PATH C:\wamp64\www\caglaustundag\resources\views/client/layout.blade.php ENDPATH**/ ?>