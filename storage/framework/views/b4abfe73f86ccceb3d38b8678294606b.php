                ...
                <div class="content-grid-compact">
                    ...
                    <div class="main-content-compact">
                        ...
                        <div class="cta-box-compact">
                            ...
                            <a href="<?php echo e(route('showPage', [App::getLocale(), 'iletisim'])); ?>" class="btn-cta-compact">
                    ...
                    <aside class="sidebar-compact">
                        <div class="sidebar-box-compact">
                            <h4><?php echo e(__('Diğer Hizmetler')); ?></h4>
...
<?php else: ?>
    ...
    <?php $__env->startSection('content'); ?>
        <section class="services-hero-compact">
            <div class="container">
                <span class="section-label-compact"><?php echo e(__('Hizmetlerimiz')); ?></span>
                <h1 class="section-heading-compact"><?php echo e(__('Profesyonel Çözümler')); ?></h1>
                <p class="section-desc-compact"><?php echo e(__('İşletmenizin büyümesi için sunduğumuz danışmanlık hizmetleri')); ?></p>
            </div>
        </section>
